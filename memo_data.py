...
class QuestionEdit(QuestionViev):
...
class Answer_Check(QuestionViev):
...
def random_AnswerCheck(list_model, w_question, widgets_list, w_showed_answer, w_result):
    ...
    frm_card = Answer_Check(frm, w_question, widgets_list[0], widgets_list[1], widgets_list[2], widgets_list[3], w_showed_answer, w_result)
    return frm_card
